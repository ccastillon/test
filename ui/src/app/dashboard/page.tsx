    ...
    <>
      <div className="h-full flex flex-wrap mt-6">
        <div className="relative z-20 w-full max-w-full px-3 lg:flex-0 shrink-0">
              ...
              <div className="flex flex-wrap -ml-3">
                <div className="w-full max-w-full px-3 lg:flex-0 shrink-0 lg:w-6/12">
                  <div className="flex flex-col h-full">
                    <h2 className="mb-0 font-bold dark:text-white">
                      General Statistics
                    </h2>
                  </div>
                </div>
          ...
          <div className="flex flex-wrap -mx-3">
                ...
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                      <div>
                        <p className="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">
                          Today&lsquo;s Money
                        </p>
            ...
            <div className="w-full max-w-full px-3 mt-6 sm:flex-0 shrink-0 sm:mt-0 sm:w-6/12 lg:w-5/12">
              <div className="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    <div className="flex-none w-2/3 max-w-full px-3">
                ...
                <div className="flex-auto p-4">
                  <div className="flex flex-wrap -mx-3">
                    ...
                    <div className="w-4/12 max-w-full px-3 text-right flex-0">
                      <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl">
                        <i
                          className="ni leading-none ni-cart text-lg relative top-3.5 text-white"
                          aria-hidden="true"
                        />
                      </div>
                    </div>
          ...
          <div className="flex flex-wrap mt-6 -mx-3">
            <div className="w-full max-w-full px-3 flex-0 lg:w-10/12">
              <div className="relative flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
        ...
        <div className="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
          <div className="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 shadow-soft-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
            <div className="flex-auto p-4">
              ...
              <p className="ml-2 text-sm leading-normal dark:opacity-60">
                ...
                <div className="flex flex-wrap mt-0 -mx-3">
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    <div className="flex mb-2">
                      ...
                      <p className="mt-1 mb-0 text-xs font-semibold leading-tight dark:opacity-60">
                        Users
                      </p>
                    </div>
                  ...
                  <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                    ...
                    <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                      <div
                        className="duration-600 ease-soft -mt-0.4 -ml-px flex h-1.5 w-1/2 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all"
                        role="progressbar"
                        aria-valuenow={50}
                        aria-valuemin={0}
                        aria-valuemax={100}
      ...
      {/* <div className="flex flex-wrap -mx-3">
        <div className="w-full max-w-full px-3 flex-0">
          <div
            id="globe"
            className="absolute right-0 mt-24 lg-max:overflow-hidden top-1/10 sm:mt-4 lg:mr-24"
          >
            <canvas
              width={700}
              height={600}
              className="w-3/4 -mr-48 h-3/4 lg-max:w-full lg:mt-12 lg:mr-0 lg:w-full"
            />
          </div>
        </div>
      </div> */}
      ...
      <LoadScript
        scripts={[
          ...
          // "/assets/js/plugins/threejs.js",
          // "/assets/js/plugins/orbit-controls.js",

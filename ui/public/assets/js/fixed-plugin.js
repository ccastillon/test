...
var sidenav_card_icon = sidenav.querySelector(
  "[sidenav-card-icon]"
).parentElement;
var sidenav_card_content = sidenav.querySelector("i[sidenav-card-icon]")
...
function normal_sidenav() {
  ...
  normal_spans.forEach((normal_span) => {
    ...
    if (normal_span.previousElementSibling.tagName.toLowerCase() == "span") {
      ...
      normal_span.previousElementSibling.tagName.toLowerCase() != "img"
    ) {
    }
    normal_span.classList.add("opacity-100");
  });
